...
public interface UsuarioRepositorio extends JpaRepository<Usuario, Long> {
    ...
    public void updateUser(@Param("nombre") String nombre, @Param("apellido") String apellido, @Param("correo_electronico") String correo_electronico, @Param("saldo") long saldo, @Param("id_usuario") long id_usuario , @Param("porcentaje_ahorro") double porcentaje_ahorro);
