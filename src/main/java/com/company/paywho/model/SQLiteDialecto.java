 ...
 */
public class SQLiteDialecto extends Dialect {

    private final UniqueDelegate uniqueDelegate;

    public SQLiteDialecto(DialectResolutionInfo info) {
        this(info.makeCopy());
        registerKeywords(info);
    }

    public SQLiteDialecto() {
        this(DatabaseVersion.make(2, 0));
    }

    public SQLiteDialecto(DatabaseVersion version) {
        super(version);
    ...
    private static class SQLiteUniqueDelegate extends AlterTableUniqueDelegate {
        ...
        /**
         * Alter table support in SQLite is very limited and does not include
         * adding a unique constraint (as of 9/2023).
         *
         * @return always empty String
         * @see <a href="https://www.sqlite.org/omitted.html">SQLite SQL
         * omissions</a>
         */
        @Override
    ...
    /**
     * Generated keys are not supported by the (standard) Xerial driver
     * (9/2022).
     *
     * @return false
     */
